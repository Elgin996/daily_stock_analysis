...
from src.services.eastmoney_client import eastmoney_get
...
def _eastmoney_get(url: str, **kwargs) -> requests.Response:
    """GET EastMoney through the project-wide process-safe throttle."""
    response = eastmoney_get(url, max_attempts=3, **kwargs)
