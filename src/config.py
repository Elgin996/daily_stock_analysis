...
class Config:
    ...
    # 实时行情数据源优先级（逗号分隔）
    # 推荐顺序：tencent > pytdx > akshare_sina > efinance > akshare_em > tushare
    # - tencent: 腾讯财经，有量比/换手率/市盈率等，单股查询稳定（推荐）
    # - akshare_sina: 新浪财经，基本行情稳定，但无量比
    # - efinance/akshare_em: 东财全量接口，数据最全但容易被封
    # - tushare: Tushare Pro，需要2000积分，数据全面（付费用户可优先使用）
    realtime_source_priority: str = "tencent,pytdx,akshare_sina,efinance,akshare_em"
    # 实时行情缓存时间（秒）
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            # - pytdx: 通达信 TCP，提供基础实时量价，作为独立协议备用源
            # - akshare_sina: 新浪财经，基本行情稳定，但无量比
            # - efinance/akshare_em: 东财全量接口，数据最全但容易被封
    ...
    def _resolve_realtime_source_priority(cls) -> str:
        ...
        default_priority = 'tencent,pytdx,akshare_sina,efinance,akshare_em'
